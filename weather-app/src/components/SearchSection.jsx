const SearchSection = ({ getWeatherDeatails, searchInputRef }) => 
{
    ...
    const handleCitySearch = (e) => {
      ...
      key=${API_KEY}&q=${searchInput.value}&days=2`;
  ...
  const handleLocationSearch = () => {
    navigator.geolocation.getCurrentPosition(
      (position) => {
        ...
        const API_URL = `http://api.weatherapi.com/v1/forecast.
        json?key=${API_KEY}&q=${longitude},${latitude}&days=2`;
  ...
  return (
    ...
    <form action="#" className="search-form" onSubmit=
    {handleCitySearch}>
